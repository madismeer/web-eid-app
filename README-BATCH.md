...
# Web-eid-batch-signer
At the moment web-eid app does not support batch signing. This is a workaround to sign multiple files at once.

Default input was only abel to take one hash at a time. This is a workaround to take multiple hashes at once.

Default input:

./web-eid -c sign  '{"hash":"c076GeyE7+NinO/Sqxnqx2v08+GrjVbn1y1uwTwdwWQ=","hashFunction":"SHA-256","certificate":"Add yours here,"origin":"https://www.ria.ee","lang":"et"}'

Default output:

{"signature":"NOVlNNv3MZZcdfnLtJAsronnnHpVkBrT/LsxcSWLQY/ka3nb9yxPFL9Ij1oYeNJzmv4waJcTldkvorsxuf9m3vNA9VUTSAT8nwPV53zOlQQ3E+ncbv2EjCy0bgaml/ol","signatureAlgorithm":{"cryptoAlgorithm":"ECC","hashFunction":"SHA-256","paddingScheme":"NONE"}}


Batch input:

./web-eid -c sign  '{"hash":"c076GeyE7+NinO/Sqxnqx2v08+GrjVbn1y1uwTwdwWQ=,c076GeyE7+NinO/Sqxnqx2v08+GrjVbn1y1uwTwdwWQ=","hashFunction":"SHA-256","certificate":"add yours here","origin":"https://www.ria.ee","lang":"et"}'


Batch output:

{"signature":"81ctBcp5t892SjU3UmgtdSh+gPrwWIq1vSbToLWAl2EEMAg8qc4wl7HpSLfig5/t8rAKIBKpuj7zQ7aNiQdwWM585f9KZxf2Zdj8JpLzSTVXw0ucLJf8RyGf7bPkp5gu,NUoNLXOUz1JP4jAPZjwEOsvaj+XlP6Y3f8L+qj+wW8PeahW0aZlw0bx1zWQPQy34On5WwrfI/z/pTcoKtboT9vBv2YWAPJ6t81r5uxYRX/808z7CwCkMvw5dk6bEPL8d","signatureAlgorithm":{"cryptoAlgorithm":"ECC","hashFunction":"SHA-256","paddingScheme":"NONE"}}

Input hashes have to be seperated by a comma, and the output signatures will be seperated by a comma aswell.


The only meaningful changes are in sign.cpp and sign.hpp.


Currently have no idea how to validate the signatures.
